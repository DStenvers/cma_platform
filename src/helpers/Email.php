...
class Email
{
    ...
    {
        // SMTP: the MAIL_* settings (Beheerstools → Systeeminstellingen); the
        // registry falls back to a site's older mail_* keys in app.php.
        $mailServer = (string) Settings::get('mail_host') ?: 'localhost';
        $mailPort = (int) Settings::get('mail_port') ?: 25;
        $mailUsername = (string) Settings::get('mail_username');
        $mailPassword = (string) Settings::get('mail_password');
