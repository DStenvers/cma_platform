...
final class Settings
{
    private const GROUPS = [
        ...
        'session'       => ['caption' => 'Sessie & login',       'order' => 150],
        'logging'       => ['caption' => 'Logging',              'order' => 200],
        'retention'     => ['caption' => 'Logs & retentie',      'order' => 250],
        'mail'          => ['caption' => 'Mailserver',           'order' => 300],
        'branding'      => ['caption' => 'Branding & taal',      'order' => 350],
        'lists'         => ['caption' => 'Lijsten',              'order' => 400],
        'dashboard'     => ['caption' => 'Dashboard & client',   'order' => 450],
        'uploads'       => ['caption' => 'Uploads & afbeeldingen', 'order' => 430],
        'editor'        => ['caption' => 'Editor',               'order' => 440],
    ...
    private const PLATFORM = [
        ...
        // ---- Sessie & login ----
        'session_cookie_lifetime' => ['env' => 'SESSION_COOKIE_LIFETIME', 'type' => 'int', 'default' => 0, 'min' => 0, 'max' => 2592000, 'group' => 'session',
            'label' => 'Levensduur sessiecookie (s)', 'hint' => 'Seconden dat de PHP-sessie in de browser blijft. 0 = tot de browser sluit.',
            'doc' => 'Bootstrap::initSession() — lifetime van de sessiecookie; 0 = browsersessie.'],
        'session_cookie_secure' => ['env' => 'SESSION_COOKIE_SECURE', 'type' => 'bool', 'default' => false, 'group' => 'session',
            'label' => 'Sessiecookie alleen via HTTPS', 'hint' => 'Aanzetten zodra de site volledig op https draait.',
            'doc' => 'Bootstrap::initSession() — secure-vlag van de sessiecookie.'],
        'session_cookie_samesite' => ['env' => 'SESSION_COOKIE_SAMESITE', 'type' => 'select', 'default' => 'Lax', 'group' => 'session',
            'options' => ['Lax' => 'Lax', 'Strict' => 'Strict', 'None' => 'None (vereist HTTPS)'],
            'label' => 'SameSite-beleid sessiecookie', 'hint' => 'Strict is veiliger maar breekt terugkeer vanaf een externe betaal- of loginpagina.',
            'doc' => 'Bootstrap::initSession() — SameSite van de sessiecookie.'],
        'auth_cookie_lifetime' => ['env' => 'AUTH_COOKIE_LIFETIME', 'type' => 'int', 'default' => 0, 'min' => 0, 'max' => 31536000, 'group' => 'session',
            'label' => 'Ingelogd blijven (s)', 'hint' => 'Seconden dat de inlogcookies van het CMA geldig blijven. 0 = tot de browser sluit.',
            'doc' => 'cma/login.php en sso_callback.php — levensduur van de inlogcookies (CMAU, CMAG, laatste login); 0 = browsersessie.'],
        'cookie_secure' => ['env' => 'COOKIE_SECURE', 'type' => 'bool', 'default' => false, 'group' => 'session',
            'label' => 'Cookies alleen via HTTPS', 'hint' => 'Geldt voor de inlog-, voorkeur- en SSO-cookies die het CMA zet. Aanzetten op elke site met een geldig certificaat.',
            'doc' => 'Cookie::set() (standaard secure-vlag) en de SSO-statecookies.'],
        'preference_cookie_days' => ['env' => 'PREFERENCE_COOKIE_DAYS', 'type' => 'int', 'default' => 365, 'min' => 1, 'max' => 3650, 'group' => 'session',
            'label' => 'Bewaartermijn voorkeuren-cookies (dagen)', 'hint' => 'Dagen dat thema, popupstijl en kolomkeuze in de browser blijven staan.',
            'doc' => 'UserPreferences en TableService — levensduur van de voorkeurencookies.'],
        ...
        'sql_log_file' => ['env' => 'SQL_LOG_FILE', 'type' => 'text', 'default' => '', 'group' => 'logging',
            'label' => 'Pad SQL-log', 'hint' => 'Relatief pad hangt aan de siteroot. Leeg = sql_queries.log in de hoofdmap.',
        ...
        'profiler_log_file' => ['env' => 'PROFILER_LOG_FILE', 'type' => 'text', 'default' => '', 'group' => 'logging',
            'label' => 'Pad profilerlog', 'hint' => 'Relatief pad hangt aan de siteroot. Leeg = profiler.csv in de hoofdmap.',
        ...
        // ---- Logs & retentie ----
        'app_log_retention_days' => ['env' => 'APP_LOG_RETENTION_DAYS', 'type' => 'int', 'default' => 30, 'min' => 1, 'max' => 365, 'group' => 'retention',
            'label' => 'Bewaartermijn applicatielog', 'hint' => 'Dagen dat .logs/app bewaard blijft; opgeruimd bij "Logs opruimen" in de logreader.',
            'doc' => 'Logger::cleanup() — dagen dat de applicatielog (.logs/app) bewaard blijft.'],
        'perf_log_retention_days' => ['env' => 'PERF_LOG_RETENTION_DAYS', 'type' => 'int', 'default' => 7, 'min' => 1, 'max' => 365, 'group' => 'retention',
            'label' => 'Bewaartermijn performancelog', 'hint' => 'Dagen dat performance-logbestanden bewaard blijven.',
            'doc' => 'PerformanceLogger::cleanup() — dagen dat .logs/perf bewaard blijft.'],
        'debug_log_retention_days' => ['env' => 'DEBUG_LOG_RETENTION_DAYS', 'type' => 'int', 'default' => 7, 'min' => 1, 'max' => 365, 'group' => 'retention',
            'label' => 'Bewaartermijn debug-/browserlog', 'hint' => 'Dagen dat libLog-bestanden bewaard blijven.',
            'doc' => 'api/log.php — dagen dat .logs/debug bewaard blijft.'],
        'notfound_log_retention_days' => ['env' => 'NOTFOUND_LOG_RETENTION_DAYS', 'type' => 'int', 'default' => 60, 'min' => 1, 'max' => 365, 'group' => 'retention',
            'label' => 'Bewaartermijn 404-log', 'hint' => 'Dagen dat de dagelijkse 404-logs bewaard blijven; opgeruimd na het dagelijkse overzicht.',
            'doc' => 'NotFoundDigest::prune() — dagen dat .logs/404 bewaard blijft (opruiming draait na het dagelijkse overzicht, dus alleen met NOTFOUND_MAIL_ENABLED aan).'],
        'email_log_retention_days' => ['env' => 'EMAIL_LOG_RETENTION_DAYS', 'type' => 'int', 'default' => 30, 'min' => 1, 'max' => 365, 'group' => 'retention',
            'label' => 'Bewaartermijn e-maillog', 'hint' => 'Dagen dat verzonden mail in de e-mail log blijft staan.',
            'doc' => 'EmailLogService::cleanup() — dagen dat tblEmailLog bewaard blijft (opruiming bij elke tiende insert).'],
        'error_mail_throttle_seconds' => ['env' => 'ERROR_MAIL_THROTTLE_SECONDS', 'type' => 'int', 'default' => 3600, 'min' => 60, 'max' => 86400, 'group' => 'retention',
            'label' => 'Herhaalinterval foutmail (s)', 'hint' => 'Dezelfde fout wordt hoogstens eens per dit aantal seconden gemaild.',
            'doc' => 'ErrorHandler — markerbestand per foutsignatuur in .logs/phperrors/mailed; binnen dit interval geen tweede mail.'],
        'notfound_digest_top' => ['env' => 'NOTFOUND_DIGEST_TOP', 'type' => 'int', 'default' => 30, 'min' => 5, 'max' => 200, 'group' => 'retention',
            'label' => 'Aantal paden in 404-mail', 'hint' => 'Hoeveel paden het dagelijkse overzicht opsomt.',
            'doc' => 'NotFoundDigest — aantal paden in het dagelijkse overzicht; de rest als aantal.'],
        'log_min_level' => ['env' => 'LOG_MIN_LEVEL', 'type' => 'select', 'default' => '', 'optional' => true, 'group' => 'retention',
            'options' => ['debug' => 'DEBUG en hoger', 'info' => 'INFO en hoger', 'notice' => 'NOTICE en hoger', 'warning' => 'WARNING en hoger', 'error' => 'ERROR en hoger'],
            'placeholder' => 'Automatisch (WARNING op productie, anders DEBUG)',
            'label' => 'Minimaal logniveau', 'hint' => 'Vanaf welk niveau er naar het applicatielog wordt geschreven. Leeg = WARNING op productie, DEBUG elders.',
            'doc' => 'Services\Logger — minimumniveau voor .logs/app; leeg = afgeleid van de omgeving.'],
        'js_error_rate_limit' => ['env' => 'JS_ERROR_RATE_LIMIT', 'type' => 'int', 'default' => 100, 'min' => 0, 'max' => 10000, 'group' => 'retention',
            'label' => 'Max. JS-fouten per IP', 'hint' => 'Bovengrens per tijdvenster; daarboven worden meldingen genegeerd.',
            'doc' => 'form_api.php (logJsError) — meldingen per IP per venster.'],
        'js_error_rate_window' => ['env' => 'JS_ERROR_RATE_WINDOW', 'type' => 'int', 'default' => 3600, 'min' => 60, 'max' => 86400, 'group' => 'retention',
            'label' => 'Tijdvenster JS-foutlimiet (s)', 'hint' => 'Periode waarover bovenstaande limiet telt.',
            'doc' => 'form_api.php (logJsError) — venster van de limiet.'],
        ...
        // ---- Branding & taal ----
        'app_name' => ['env' => 'APP_NAME', 'type' => 'text', 'default' => '', 'group' => 'branding', 'app' => ['appname_simple', 'appname', 'Name'],
            'label' => 'Applicatienaam', 'hint' => 'Titel in de browsertab en op foutpagina\'s. Leeg = CMA.',
            'doc' => 'main.php (paginatitel) en ErrorHandler (foutpagina); leeg = appname_simple/appname/Name uit app.php, anders CMA.'],
        'cma_language' => ['env' => 'CMA_LANGUAGE', 'type' => 'select', 'default' => 'NL', 'group' => 'branding', 'app' => 'cma_language',
            'options' => ['NL' => 'Nederlands', 'UK' => 'English'],
            'label' => 'Taal beheerscherm', 'hint' => 'Taal van knoppen en meldingen in het CMA.',
            'doc' => 'Alle CMA-schermen (voorheen gelezen onder cma_language, CMA_Language en CMA_LANGUAGE) — NL of UK.'],
        'mod_language' => ['env' => 'MOD_LANGUAGE', 'type' => 'select', 'default' => '', 'optional' => true, 'group' => 'branding', 'app' => 'mod_language',
            'options' => ['NL' => 'Nederlands', 'UK' => 'English'], 'placeholder' => 'Nederlands',
            'label' => 'Taal front-end formulieren', 'hint' => 'Taal van validatiemeldingen en de kalender op de website zelf.',
            'doc' => 'library/lib_form.inc, class_calendar.inc, Error en login — UK schakelt de Engelse teksten in; leeg = Nederlands.'],
        'library_relative_dates' => ['env' => 'LIBRARY_RELATIVE_DATES', 'type' => 'bool', 'default' => false, 'group' => 'branding', 'app' => 'library_relative_dates',
            'label' => 'Relatieve datums tonen', 'hint' => '"Vandaag" en "gisteren" in plaats van een datum.',
            'doc' => 'Date::formatRelative e.d. — relatieve datumnamen.'],
        ...
        'list_default_columns' => ['env' => 'LIST_DEFAULT_COLUMNS', 'type' => 'int', 'default' => 6, 'min' => 1, 'max' => 100, 'group' => 'lists',
            'label' => 'Kolommen in de tabelweergave', 'hint' => 'Hoeveel velden een lijst standaard als kolom toont, in de volgorde van het detailformulier. Een eigen kolomkeuze (kolomkiezer) of listColumns in de definitie gaat vóór en kent geen grens.',
            'doc' => 'JsonFormService en TableService: de standaardkolommen van de tabelweergave als er geen kolomkeuze is opgeslagen en de definitie geen listColumns heeft. Subformulieren (eigen listQuery) vallen er niet onder.'],
        'list_prefetch_max_rows' => ['env' => 'LIST_PREFETCH_MAX_ROWS', 'type' => 'int', 'default' => 1000, 'min' => 0, 'max' => 100000, 'group' => 'lists', 'client' => 'listPrefetchMaxRows',
            'label' => 'Achtergrond-laden tot', 'hint' => 'Na de eerste pagina haalt een lijst de rest op de achtergrond op, tot dit aantal rijen; wat er nog meer is, laadt bij doorscrollen. 0 = nooit op de achtergrond.',
            'doc' => 'form-controller.js (_autoPrefetchRows): stopt het achtergrond-laden zodra de lijst zoveel rijen heeft. Elke bijgeladen stap kost meer dan de vorige (de kolomfilters en de rijtelling lopen over de hele tabel), dus een lijst van tienduizenden rijen zou de browser minutenlang blokkeren.'],
        ...
        'upload_max_mb' => ['env' => 'UPLOAD_MAX_MB', 'type' => 'int', 'default' => 0, 'min' => 1, 'max' => 2048, 'optional' => true, 'group' => 'uploads', 'client' => 'uploadMaxMb',
            'label' => 'Maximale uploadgrootte (MB)', 'hint' => 'Groter wordt geweigerd, vóór en na het versturen. Leeg = de grens van de server (php.ini); hoger dan die grens kan nooit.',
            'doc' => 'Upload::maxBytes() — elke upload (LibUpload, afbeeldingswizard, bijsnijden, bestandsbrowser) weigert boven deze grens; php.ini (upload_max_filesize, post_max_size) blijft de bovengrens. lib-fileuploader controleert vooraf.'],
        'upload_image_mime_types' => ['env' => 'UPLOAD_IMAGE_MIME_TYPES', 'type' => 'list', 'default' => ['image/jpeg', 'image/png', 'image/gif', 'image/webp'], 'group' => 'uploads',
            'label' => 'Toegestane afbeeldingstypen', 'hint' => 'MIME-types die de afbeeldingswizard accepteert, kommagescheiden.',
            'doc' => 'form_api.php (uploadImage) — MIME-types die de afbeeldingswizard accepteert.'],
        'image_default_path' => ['env' => 'IMAGE_DEFAULT_PATH', 'type' => 'text', 'default' => '/images/', 'group' => 'uploads', 'app' => 'path_images',
            'label' => 'Standaardmap afbeeldingen', 'hint' => 'Waar de afbeeldingswizard uploads neerzet als het formulier geen map meegeeft.',
            'doc' => 'form_api.php (uploadImage) — doelmap als het formulier er geen meegeeft.'],
        'image_webp_quality' => ['env' => 'IMAGE_WEBP_QUALITY', 'type' => 'int', 'default' => 85, 'min' => 40, 'max' => 100, 'group' => 'uploads',
            'label' => 'WebP-kwaliteit', 'hint' => 'Hoger = mooier en zwaarder. 85 is een goede balans.',
            'doc' => 'ResponsiveImage::defaultQuality() — WebP-kwaliteit van uploads en varianten.'],
        'image_jpeg_quality' => ['env' => 'IMAGE_JPEG_QUALITY', 'type' => 'int', 'default' => 92, 'min' => 40, 'max' => 100, 'group' => 'uploads',
            'label' => 'JPEG-kwaliteit', 'hint' => 'Gebruikt als de server geen WebP kan maken.',
            'doc' => 'form_api.php (uploadImage) — JPEG-kwaliteit zonder WebP-ondersteuning.'],
        'image_crop_quality' => ['env' => 'IMAGE_CROP_QUALITY', 'type' => 'int', 'default' => 97, 'min' => 40, 'max' => 100, 'group' => 'uploads',
            'label' => 'Kwaliteit na bijsnijden', 'hint' => 'Kwaliteit waarmee een bijgesneden foto wordt opgeslagen.',
            'doc' => 'imageupload_crop.php — compressie van het bijsnijdresultaat.'],
        'responsive_image_sizes' => ['env' => 'RESPONSIVE_IMAGE_SIZES', 'type' => 'list', 'item' => 'int', 'default' => [300, 400, 800, 1200], 'group' => 'uploads',
            'label' => 'Breedtes responsieve varianten', 'hint' => 'Komma-gescheiden pixelbreedtes die per afbeelding worden gegenereerd. Bestaande varianten blijven staan.',
            'doc' => 'ResponsiveImage::sizes() — breedtes van de WebP-varianten in .responsive/.'],

        // ---- Editor ----
        'editor_image_max_width' => ['env' => 'EDITOR_IMAGE_MAX_WIDTH', 'type' => 'int', 'default' => 800, 'min' => 100, 'max' => 6000, 'group' => 'editor', 'app' => 'cma_htmledit_img_maxwidth', 'client' => 'editorImageMaxWidth',
            'label' => 'Max. breedte afbeelding in editor', 'hint' => 'Grotere afbeeldingen worden bij uploaden verkleind.',
            'doc' => 'FormTemplate, template_edit.php en form_api.php (uploadImage) — maximale breedte van editor-afbeeldingen.'],
        'editor_image_max_height' => ['env' => 'EDITOR_IMAGE_MAX_HEIGHT', 'type' => 'int', 'default' => 600, 'min' => 100, 'max' => 6000, 'group' => 'editor', 'app' => 'cma_htmledit_img_maxheight', 'client' => 'editorImageMaxHeight',
            'label' => 'Max. hoogte afbeelding in editor', 'hint' => 'Idem; de verhouding blijft behouden.',
            'doc' => 'FormTemplate, template_edit.php en form_api.php (uploadImage) — maximale hoogte van editor-afbeeldingen.'],
        'editor_image_path' => ['env' => 'EDITOR_IMAGE_PATH', 'type' => 'text', 'default' => '', 'group' => 'editor', 'app' => 'cma_htmledit_img_path',
            'label' => 'Afbeeldingsmap editor', 'hint' => 'Map waarin de editor afbeeldingen zoekt en plaatst.',
            'doc' => 'FormTemplate, template_edit.php, wizards/link-pages.php en tools_db_consistency — map van editor-afbeeldingen.'],
        'editor_css' => ['env' => 'EDITOR_CSS', 'type' => 'text', 'default' => '', 'group' => 'editor', 'app' => 'cma_htmledit_css', 'client' => 'editorCss',
            'label' => 'Stylesheet in de editor', 'hint' => 'URL van de CSS zodat tekst in de editor er uitziet als op de site. Leeg = de standaard van de editor.',
            'doc' => 'main.php, FormTemplate en template_edit.php — contentsCss van CKEditor; leeg = cma/ckeditor/contents.css.'],
        'editor_allow_br' => ['env' => 'EDITOR_ALLOW_BR', 'type' => 'bool', 'default' => true, 'group' => 'editor', 'app' => 'cma_htmledit_allowBR', 'app_invert' => true,
            'label' => 'Enter maakt een regeleinde', 'hint' => 'Uit = Enter maakt een nieuwe alinea in plaats van een regeleinde.',
            'doc' => 'main.php, FormTemplate en template_edit.php — allowBR van CKEditor. De oudere key cma_htmledit_allowBR betekent het omgekeerde en wordt omgedraaid gelezen.'],

        // ---- Dashboard & client ----
        'dashboard_stats_days' => ['env' => 'DASHBOARD_STATS_DAYS', 'type' => 'int', 'default' => 7, 'min' => 1, 'max' => 90, 'group' => 'dashboard',
            'label' => 'Periode dashboardstatistieken (dagen)', 'hint' => 'Over hoeveel dagen gebruik, fouten en formulieren worden geteld.',
            'doc' => 'api/dashboard_stats.php — venster van de activiteits-, fouten- en formulierkaarten.'],
        'dashboard_notfound_days' => ['env' => 'DASHBOARD_NOTFOUND_DAYS', 'type' => 'int', 'default' => 14, 'min' => 1, 'max' => 90, 'group' => 'dashboard',
            'label' => 'Periode 404-grafiek (dagen)', 'hint' => 'Hoe ver de grafiek met niet-gevonden pagina\'s terugkijkt.',
            'doc' => 'api/dashboard_stats.php — venster van de 404-kaart.'],
        'perf_client_batch_size' => ['env' => 'PERF_CLIENT_BATCH_SIZE', 'type' => 'int', 'default' => 20, 'min' => 1, 'max' => 500, 'group' => 'dashboard', 'client' => 'perfBatchSize',
            'label' => 'Meetpunten per verzending', 'hint' => 'Hoeveel browsermetingen in één keer naar de server gaan.',
            'doc' => 'cma/assets/js/perf-logger.js — batchgrootte van de browsermetingen.'],
        'perf_client_batch_interval' => ['env' => 'PERF_CLIENT_BATCH_INTERVAL', 'type' => 'int', 'default' => 5000, 'min' => 500, 'max' => 60000, 'group' => 'dashboard', 'client' => 'perfBatchInterval',
            'label' => 'Verzendinterval metingen (ms)', 'hint' => 'Hoe vaak de browser verzamelde metingen doorstuurt.',
            'doc' => 'cma/assets/js/perf-logger.js — interval van de verzending.'],
        'perf_client_max_queue' => ['env' => 'PERF_CLIENT_MAX_QUEUE', 'type' => 'int', 'default' => 200, 'min' => 20, 'max' => 5000, 'group' => 'dashboard', 'client' => 'perfMaxQueue',
            'label' => 'Max. metingen in wachtrij', 'hint' => 'Bovengrens zodat een trage server het geheugen niet volloopt.',
            'doc' => 'cma/assets/js/perf-logger.js — wachtrijlimiet.'],
        'table_filter_max_values' => ['env' => 'TABLE_FILTER_MAX_VALUES', 'type' => 'int', 'default' => 500, 'min' => 50, 'max' => 20000, 'group' => 'dashboard', 'client' => 'tableFilterMaxValues',
            'label' => 'Filterlijst opsommen tot', 'hint' => 'Boven dit aantal rijen toont een kolomfilter een zoekveld in plaats van alle waarden.',
            'doc' => 'lib-table — rijen waarboven een kolomfilter geen waarden meer opsomt.'],
        'table_filter_max_checkboxes' => ['env' => 'TABLE_FILTER_MAX_CHECKBOXES', 'type' => 'int', 'default' => 30, 'min' => 5, 'max' => 500, 'group' => 'dashboard', 'client' => 'tableFilterMaxCheckboxes',
            'label' => 'Max. aanvinkbare filterwaarden', 'hint' => 'Daarboven wordt het kolomfilter een vrije-tekstzoekveld.',
            'doc' => 'lib-table — unieke waarden waarboven een kolomfilter een tekstveld wordt.'],
        ...
        // ---- SSO (the older sso_*/cma_sso_* keys in app.php remain the fallback) ----
        'sso_enabled' => ['env' => 'SSO_ENABLED', 'type' => 'bool', 'default' => false, 'group' => 'sso', 'app' => 'cma_sso_enabled',
            'label' => 'Inloggen via SSO', 'hint' => 'Toont de SSO-knop op het inlogscherm.', 'doc' => 'SsoService::isEnabled().'],
        'sso_force' => ['env' => 'SSO_FORCE', 'type' => 'bool', 'default' => false, 'group' => 'sso', 'app' => 'cma_force_sso',
            'label' => 'SSO verplicht', 'hint' => 'Verbergt het wachtwoordformulier; alleen SSO blijft over.', 'doc' => 'SsoService::isForced().'],
        'sso_idp_url' => ['env' => 'SSO_IDP_URL', 'type' => 'text', 'default' => '', 'group' => 'sso', 'app' => ['sso_idp_url', 'sso_idp_conn'],
            'label' => 'Adres identity provider', 'hint' => 'Basis-URL van de SSO-server, zonder afsluitende slash.', 'doc' => 'SsoService — basis-URL van de IdP.'],
        'sso_authorize_endpoint' => ['env' => 'SSO_AUTHORIZE_ENDPOINT', 'type' => 'text', 'default' => 'oauth2/authorize', 'group' => 'sso', 'app' => 'sso_idp_authendpoint',
            'label' => 'Autorisatie-pad', 'hint' => 'Pad achter het IdP-adres waar de gebruiker naartoe wordt gestuurd.', 'doc' => 'SsoService — authorize endpoint.'],
        'sso_token_endpoint' => ['env' => 'SSO_TOKEN_ENDPOINT', 'type' => 'text', 'default' => 'oauth2/token', 'group' => 'sso', 'app' => 'sso_idp_tokenendpoint',
            'label' => 'Token-pad', 'hint' => 'Pad waar de code voor een token wordt ingewisseld.', 'doc' => 'SsoService — token endpoint.'],
        'sso_client_id' => ['env' => 'SSO_CLIENT_ID', 'type' => 'text', 'default' => '', 'group' => 'sso', 'app' => 'sso_client_id',
            'label' => 'Client-ID', 'hint' => 'Door de identity provider uitgegeven applicatie-ID.', 'doc' => 'SsoService — OAuth client id.'],
        'sso_client_secret' => ['env' => 'SSO_CLIENT_SECRET', 'type' => 'secret', 'default' => '', 'group' => 'sso', 'app' => 'sso_client_secret',
            'label' => 'Client-secret', 'hint' => 'Wordt niet getoond. Leeg laten houdt de huidige waarde.', 'doc' => 'SsoService — OAuth client secret.'],
        'sso_scope' => ['env' => 'SSO_SCOPE', 'type' => 'text', 'default' => 'openid', 'group' => 'sso', 'app' => 'sso_login_scope',
            'label' => 'Scope', 'hint' => 'Welke gegevens worden opgevraagd, spatie-gescheiden.', 'doc' => 'SsoService — OAuth scope.'],
        'sso_response_type' => ['env' => 'SSO_RESPONSE_TYPE', 'type' => 'text', 'default' => 'code', 'group' => 'sso', 'app' => 'sso_login_type',
            'label' => 'Response type', 'hint' => 'Vrijwel altijd code.', 'doc' => 'SsoService — response_type.'],
        'sso_prompt' => ['env' => 'SSO_PROMPT', 'type' => 'text', 'default' => 'login', 'group' => 'sso', 'app' => 'sso_login_prompt',
            'label' => 'Prompt-gedrag', 'hint' => 'login dwingt opnieuw inloggen af, none gebruikt een bestaande sessie.', 'doc' => 'SsoService — prompt-parameter.'],
        'sso_grant_type' => ['env' => 'SSO_GRANT_TYPE', 'type' => 'text', 'default' => 'authorization_code', 'group' => 'sso', 'app' => 'sso_grand_type',
            'label' => 'Grant type', 'hint' => 'Vrijwel altijd authorization_code.', 'doc' => 'SsoService — grant_type (de oudere app.php-key heet sso_grand_type).'],
        'sso_client_base_url' => ['env' => 'SSO_CLIENT_BASE_URL', 'type' => 'text', 'default' => '', 'group' => 'sso', 'app' => 'sso_client_base_url',
            'label' => 'Basis-URL van deze site', 'hint' => 'Leeg = afleiden uit het verzoek. Vullen bij een reverse proxy.', 'doc' => 'SsoService — basis voor de redirect-URI.'],
        'sso_callback_url' => ['env' => 'SSO_CALLBACK_URL', 'type' => 'text', 'default' => 'cma/sso_callback.php', 'group' => 'sso', 'app' => 'cma_sso_callback_url',
            'label' => 'Callback-pad', 'hint' => 'Moet exact overeenkomen met de redirect-URI bij de identity provider.', 'doc' => 'SsoService — callback-pad.'],
        'sso_provider_name' => ['env' => 'SSO_PROVIDER_NAME', 'type' => 'text', 'default' => 'SSO login', 'group' => 'sso', 'app' => 'sso_provider_name',
            'label' => 'Naam op de inlogknop', 'hint' => 'Bijvoorbeeld "Inloggen met Microsoft".', 'doc' => 'SsoService — label van de SSO-knop.'],

        // ---- Overig ----
        'cma_monitoring' => ['env' => 'CMA_MONITORING', 'type' => 'bool', 'default' => false, 'group' => 'misc', 'app' => 'cma_monitoring',
            'label' => 'Wijzigingen bijhouden', 'hint' => 'Legt per record vast wie wat wanneer heeft aangepast (CMA Monitoring).',
            'doc' => 'FormDataProvider::logMonitoring() — schrijft tblCMAMonitoring bij elke save en delete.'],
