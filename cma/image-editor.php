...
$ieJs = minify_asset('../library/assets/js/error-handler.js,../library/webcomponents/lib-message.js,../library/webcomponents/lib-toaster.js,../library/webcomponents/lib-loader.js,webcomponents/cma-toolbar.js,assets/js/image-editor.js');
?><!DOCTYPE html>
<html lang="nl">
<head>
    <script>
