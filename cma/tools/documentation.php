...
function render_doc_troubleshooting(): void
{
    ...
    <table class="listtable">
        ...
        <tbody>
            ...
            <tr><td>DSN in de foutmelding wijst naar <code>&lt;siteroot&gt;\db\main.mdb</code> terwijl de site een andere database gebruikt</td><td><code>data</code> en <code>users</code> vallen terug op de conventionele Access-bestanden onder <code>/db</code> zodra <code>databases.json</code> ze niet definieert. De fallback maskeert een ontbrekende of onvolledige <code>data/databases.json</code>.</td><td>Controleer of <code>data/databases.json</code> bestaat en een entry <code>data</code> heeft. Zie <a href="documentation.php?topic=database">Database &amp; RecordSet</a>.</td></tr>
