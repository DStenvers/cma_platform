<?php
/**
 * DEPRECATED — legacy two-pane reports browser (cma-tree sidebar + iframe).
 *
 * Superseded by reports.php, which presents a full-width "big menu" of reports
 * grouped by module (mirroring the tools page). This archived tree view is kept
 * for one release cycle as a fallback and is reachable only by its direct URL
 * (/cma/reports_DEPRECATED.php); nothing links to it. Remove after v1.29.
 */
