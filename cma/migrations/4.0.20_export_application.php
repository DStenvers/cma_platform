...
if ($isMigration) {
    ...
    if ($result['success']) {
        echo '<lib-message type="success"><span class="cma-migration__strong">Applicatie configuratie succesvol geëxporteerd!</span><br>' . htmlspecialchars($result['message']) . '</lib-message>';
    } else {
