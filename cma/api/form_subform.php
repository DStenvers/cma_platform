...
try {
    ...
    // Per-form authorization: subform data needs at least read access on the
    // (parent) form (parity with the form_api.php path; global login is
    // already enforced by bootstrap)
