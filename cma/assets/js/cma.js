...
// Tree expand/collapse - toolbar buttons (emitted by FormTemplate/ToolbarHelper)
// drive the <cma-tree> web component.
function fExpandAll() {
    var tree = document.querySelector('#listContent cma-tree');
    if (tree && tree.expandAll) { tree.expandAll(); }
}
function fCollapseAll() {
    var tree = document.querySelector('#listContent cma-tree');
    if (tree && tree.collapseAll) { tree.collapseAll(); }
}
