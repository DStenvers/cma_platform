...
class FormTemplate
{
    ...
    private function generateHeaderForJson(string $formName): string
    {
        ...
        if ($needsCKEditor) {
            $html .= '<script src="/cma/ckeditor/ckeditor.js?v=' . cma_asset_version() . '" defer></script>' . PHP_EOL;
    ...
    private function generateDetailToolbar(): string
    {
        ...
        // Right side: the form name. No record-status text ("Wijzigen",
        // "Toevoegen"): the panel title already says which it is.
        $html .= '<div class="toolbar-right">' . PHP_EOL;
    ...
    private function generateDetailPanel(): string
    {
        ...
        if (Arr::isArray($this->arrSubForms) || $this->arrSubForms instanceof \ArrayAccess) {
            ...
            // De balk verdeelt de hoogte tussen het formulier en de subformulieren,
            // maar hij mag er maar ÉÉN opmeten. Dat is de subform-sectie: die staat
