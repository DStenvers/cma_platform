...
( function() {
	...
	CKEDITOR.plugins.add( 'myMaximize', {
...
// is this correct?
					editor.fire( 'myMaximize', this.state );
				},
				canUndo: false
			} );

			editor.ui.addButton && editor.ui.addButton( 'myMaximize', {
			...
			editor.on( 'mode', function() {
				var command = editor.getCommand( 'myMaximize' );
...
/**
 * Event fired when the myMaximize command is called.
